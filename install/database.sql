...
CREATE TABLE `admins` (
  ...
  `is_secondary_auth_enabled` tinyint(1) NOT NULL DEFAULT 0
...
INSERT INTO `admins` (`id`, `role_id`, `admin_number`, `name`, `email`, `username`, `email_verified_at`, `image`, `password`, `remember_token`, `created_at`, `updated_at`, `secondary_password`, `is_secondary_auth_enabled`) VALUES
(1, 0, NULL, 'Super Admin', 'admin@gmail.com', 'admin', NULL, '69914ac8ee3e91771129544.png', '$2y$12$WswLmh7g8cNi2G4Y1cWZN.EhO5LRg7ZkyKwMqPi/UwWtILB3/PREq', 'wS1KXYQA3PT1X5iEwwXPmc8yNPP1rGVeSECNVFfbaAB4u1l8bQED8b43N2CL', NULL, '2026-02-15 08:08:38', NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `admin_ip_bans`
--

CREATE TABLE `admin_ip_bans` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `admin_logins` (
  ...
  `admin_ip` varchar(40) DEFAULT NULL,
...
--
-- Table structure for table `ai_bots`
--

CREATE TABLE `ai_bots` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `time_setting_id` int(11) DEFAULT NULL,
  `name` varchar(255) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `price` decimal(28,8) NOT NULL,
  `max_invest` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `duration` int(11) NOT NULL DEFAULT 1,
  `daily_profit` decimal(28,8) NOT NULL,
  `min_profit` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `max_profit` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `profit_type` tinyint(4) NOT NULL DEFAULT 1,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `daily_trade_limit` int(11) NOT NULL DEFAULT 0 COMMENT '0 = Unlimited'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ai_bots`
--

INSERT INTO `ai_bots` (`id`, `time_setting_id`, `name`, `image`, `price`, `max_invest`, `duration`, `daily_profit`, `min_profit`, `max_profit`, `profit_type`, `status`, `created_at`, `updated_at`, `daily_trade_limit`) VALUES
(3, 1, 'AI Trading Bot', NULL, 1.00000000, 100.00000000, 1, 1.50000000, 1.50000000, 1.50000000, 2, 1, '2026-02-15 04:55:45', '2026-02-15 04:55:45', 10);

-- --------------------------------------------------------

--
-- Table structure for table `app_play_store_settings`
--

CREATE TABLE `app_play_store_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `app_name` varchar(255) NOT NULL DEFAULT 'My Earning App',
  `developer` varchar(255) NOT NULL DEFAULT 'ViserLab Corp',
  `version` varchar(255) NOT NULL DEFAULT '1.0.0',
  `size` varchar(255) NOT NULL DEFAULT '15 MB',
  `downloads` varchar(255) NOT NULL DEFAULT '1M+',
  `rating` varchar(255) NOT NULL DEFAULT '4.5',
  `reviews_count` varchar(255) NOT NULL DEFAULT '85K',
...
--
-- Dumping data for table `app_play_store_settings`
--

INSERT INTO `app_play_store_settings` (`id`, `app_name`, `developer`, `version`, `size`, `downloads`, `rating`, `reviews_count`, `description`, `tags`, `screenshots`, `app_logo`, `download_link`, `created_at`, `updated_at`) VALUES
(1, 'HyipX', 'HyipX', 'v1.0.0', '18.4 MB', '500,000+', '4.8', '245,812', 'HyipX is your premium gateway to financial freedom. \r\n\r\nOur platform offers:\r\n• Real-time Options Trading with live Binance feeds.\r\n• Cloud Mining infrastructure with dedicated rigs.\r\n• AI-powered Trading Bots for passive income.\r\n• Daily Rewards and aggressive Referral bonuses.\r\n\r\nJoin over 5 million users who are already building their digital wealth with HyipX. Fully secure, fast withdrawals, and 24/7 support.', '[\"Finance\",\"Earning\",\"Crypto\",\"Investment\",\"Passive Income\"]', '[\"69914dbc824261771130300.png\",\"69914dcb7da131771130315.png\",\"69914dd53981a1771130325.png\",\"69914e39839821771130425.png\"]', '6990c03bf3b7f1771094075.png', 'https://play.google.com/store/apps', '2026-01-29 07:21:46', '2026-02-15 04:40:25');
...
CREATE TABLE `aviator_bets` (
  ...
  `aviator_round_id` bigint(20) UNSIGNED NOT NULL,
  `bet_amount` decimal(28,8) NOT NULL,
  `cashout_multiplier` decimal(10,2) DEFAULT NULL,
  `payout` decimal(28,8) DEFAULT NULL,
  `status` enum('active','cashed_out','lost') NOT NULL DEFAULT 'active',
  `auto_cashout` tinyint(1) NOT NULL DEFAULT 0,
  `auto_cashout_at` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `aviator_rounds` (
  ...
  `status` enum('pending','waiting','flying','crashed') NOT NULL DEFAULT 'pending',
  `started_at` timestamp NULL DEFAULT NULL,
  `crashed_at` timestamp NULL DEFAULT NULL,
  `total_bet_amount` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `total_payout` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `total_bets` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `aviator_upcoming_results`
--

CREATE TABLE `aviator_upcoming_results` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `crash_point` decimal(10,2) NOT NULL,
...
(1, 'Interest Cron', 'interest_cron', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"interest\"]', NULL, 1, '2026-02-14 12:39:28', '2026-02-14 12:34:28', 1, 1, '2023-06-21 23:29:14', '2026-02-14 12:34:28'),
(2, 'Rank Cron', 'rank_cron', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"rank\"]', NULL, 1, '2026-02-14 12:39:28', '2026-02-14 12:34:28', 1, 1, '2023-06-22 06:04:49', '2026-02-14 12:34:28'),
(3, 'Schedule Invest', 'schedule_invest', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"investSchedule\"]', NULL, 1, '2026-02-14 12:39:28', '2026-02-14 12:34:28', 1, 1, '2023-06-22 06:10:31', '2026-02-14 12:34:28'),
(5, 'Staking Invest', 'staking_invest', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"staking\"]', NULL, 1, '2026-02-14 12:39:28', '2026-02-14 12:34:28', 1, 1, '2023-06-22 12:10:31', '2026-02-14 12:34:28');
...
INSERT INTO `daily_rewards` (`id`, `day`, `amount`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Sunday', 7.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:34'),
(2, 'Monday', 1.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:01'),
(3, 'Tuesday', 2.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:07'),
(4, 'Wednesday', 3.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:12'),
(5, 'Thursday', 4.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:17'),
(6, 'Friday', 5.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:21'),
(7, 'Saturday', 6.00000000, NULL, 1, '2026-01-31 23:37:11', '2026-02-15 04:26:29');

-- --------------------------------------------------------

--
-- Table structure for table `daily_reward_logs`
--
...
--
-- Dumping data for table `forex_pairs`
--

INSERT INTO `forex_pairs` (`id`, `name`, `symbol`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Euro / US Dollar', 'EURUSD', 1, '2026-01-30 00:14:02', '2026-01-30 00:14:02'),
(2, 'British Pound / US Dollar', 'GBPUSD', 1, '2026-01-30 00:14:03', '2026-01-30 00:14:03'),
(3, 'US Dollar / Japanese Yen', 'USDJPY', 1, '2026-01-30 00:14:03', '2026-01-30 00:14:03'),
(4, 'Australian Dollar / US Dollar', 'AUDUSD', 1, '2026-01-30 00:14:04', '2026-01-30 00:14:04'),
(5, 'US Dollar / Canadian Dollar', 'USDCAD', 1, '2026-01-30 00:14:05', '2026-01-30 00:14:05');
...
(1, 'manual_deposit', '{\"transection_screenshort\":{\"name\":\"Transection Screenshort\",\"label\":\"transection_screenshort\",\"is_required\":\"required\",\"instruction\":null,\"extensions\":\"jpg,jpeg,png\",\"options\":[],\"type\":\"file\",\"width\":\"12\"}}', '2025-12-10 08:44:24', '2025-12-10 08:44:24'),
(2, 'manual_deposit', '{\"transection_screenshort\":{\"name\":\"Transection Screenshort\",\"label\":\"transection_screenshort\",\"is_required\":\"required\",\"instruction\":null,\"extensions\":\"jpg,jpeg,png\",\"options\":[],\"type\":\"file\",\"width\":\"12\"}}', '2025-12-10 08:45:59', '2025-12-10 08:45:59'),
(4, 'withdraw_method', '{\"usdt_address\":{\"name\":\"USDT Address\",\"label\":\"usdt_address\",\"is_required\":\"required\",\"instruction\":null,\"extensions\":null,\"options\":[],\"type\":\"text\",\"width\":\"12\"}}', '2025-12-10 08:55:36', '2025-12-25 19:42:52');
...
(1, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"hyip\",\"bitcoin\",\"investment\",\"hyip business\",\"hyip script\",\"best hyip\",\"buy hyip script\",\"advanced hyip script\",\"hyip software\",\"hight yield investment program\",\"Hyip manager\",\"hyip manager script\",\"cheap hyip script\",\"realable hyip\",\"secure hyip script\",\"php hyip script\",\"new hyip script\",\"hyip program\",\"HYIPX\"],\"description\":\"Launch your ultimate earning platform with HyipX! Features PTC ads, AI trading bots, cloud mining, Aviator & casino games, VIP plans, and a modern admin panel with full control. Fully customizable and secure for investors and gamers.\",\"social_title\":\"HyipX \\u2013 All-in-One HYIP & Smart Earning Platform with PTC, AI Trading, Cloud Mining & Aviator Games\",\"social_description\":\"Launch your ultimate earning platform with HyipX! Features PTC ads, AI trading bots, cloud mining, Aviator & casino games, VIP plans, and a modern admin panel with full control. Fully customizable and secure for investors and gamers.\",\"image\":\"69914e771719a1771130487.png\"}', NULL, 'global', '', '2020-07-04 23:42:52', '2026-02-15 04:41:27'),
...
(338, 'authentication.content', '{\"whatsapp\":\"3444388547\",\"telegram\":\"90\",\"youtube\":\"980\",\"app\":\"890\"}', NULL, 'invester', '', '2022-09-19 12:04:09', '2025-12-10 09:42:29'),
...
(425, 'dashboard_link.content', '{\"whatsapp\":\"https:\\/\\/pythonlive.run.place\\/\",\"youtube\":\"https:\\/\\/www.youtube.com\\/\",\"telegram\":\"https:\\/\\/pythonlive.run.place\\/\",\"app\":\"https:\\/\\/pythonlive.run.place\\/\"}', NULL, 'invester', '', '2025-12-10 09:44:18', '2025-12-13 10:26:43'),
(426, 'links.content', '{\"whatsapp\":\"https:\\/\\/www.whatsapp.com\\/\",\"youtube\":\"https:\\/\\/www.youtube.com\\/\",\"telegram\":\"https:\\/\\/telegram.com\",\"app\":\"https:\\/\\/app.place\\/\",\"has_image\":\"1\",\"whatsapp_image\":\"6970f4ef6fd871769010415.png\"}', NULL, 'invester', '', '2025-12-23 08:21:14', '2026-01-21 20:46:55'),
(430, 'banner.element', '{\"has_image\":\"1\",\"heading\":\"hjg\",\"image\":\"6990c0a10c6071771094177.png\"}', NULL, 'invester', '', '2025-12-24 10:02:04', '2026-02-14 18:36:17'),
(431, 'links.element', '{\"name\":\"Easypaisa 1\",\"url\":\"https:\\/\\/website.com\",\"has_image\":\"1\",\"image\":\"697e443670c391769882678.png\"}', NULL, 'invester', '', '2026-01-31 22:54:59', '2026-01-31 23:04:38'),
(432, 'links.element', '{\"name\":\"Telegram\",\"url\":\"https:\\/\\/website.com\",\"has_image\":\"1\",\"image\":\"697e443f71a7d1769882687.png\"}', NULL, 'invester', '', '2026-01-31 22:59:31', '2026-01-31 23:04:47'),
(433, 'links.element', '{\"name\":\"YouTube\",\"url\":\"https:\\/\\/website.com\",\"has_image\":\"1\",\"image\":\"697e4461a0d851769882721.png\"}', NULL, 'invester', '', '2026-01-31 23:00:40', '2026-01-31 23:05:21'),
(434, 'links.element', '{\"name\":\"App Download\",\"url\":\"https:\\/\\/website.com\",\"has_image\":\"1\",\"image\":\"697e447fd19b21769882751.png\"}', NULL, 'invester', '', '2026-01-31 23:05:51', '2026-01-31 23:05:51'),
(435, 'fbr.content', '{\"heading\":\"About US\",\"description\":\"You can watch ads by investing, which will result in higher earnings. If you don\'t have an investment, you can watch ads by building your team. As your team grows, your earnings will also scale up.\",\"has_image\":\"1\",\"image\":\"69913d31e4cf91771126065.jpeg\"}', NULL, 'invester', '', '2026-02-15 03:27:45', '2026-02-15 03:56:19'),
(436, 'plan_section.content', '{\"heading\":\"Our Investment Plans.\"}', NULL, 'invester', '', '2026-02-15 03:28:40', '2026-02-15 03:28:40'),
(437, 'tutorial.content', '{\"heading\":\"Earn great investment profits with an investment of just $165! \\ud83d\\udcb0 So what are you waiting for?\",\"youtube_link\":\"https:\\/\\/www.youtube.com\\/embed\\/4zd9hzngFwY\",\"description\":\"a\"}', NULL, 'invester', '', '2026-02-15 03:30:00', '2026-02-15 03:31:28');
...
CREATE TABLE `game_settings` (
  ...
  `win_chance` decimal(5,2) NOT NULL DEFAULT 30.00,
  `min_bet` decimal(28,8) NOT NULL DEFAULT 1.00000000,
  `max_bet` decimal(28,8) NOT NULL DEFAULT 100.00000000,
  `bet_options` text DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `image` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `max_multiplier` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `game_settings` (`id`, `name`, `game_key`, `win_chance`, `min_bet`, `max_bet`, `bet_options`, `status`, `image`, `created_at`, `updated_at`, `max_multiplier`) VALUES
(1, 'Fortune Maya', 'fortune-maya', 50.00, 1.00000000, 10000.00000000, '1,2,5,10,20,50,100,500,1000', 1, '697d8b5ca42bf1769835356.png', '2026-01-19 22:35:18', '2026-02-14 12:30:44', 500),
(4, 'Aviator', 'aviator', 0.00, 1.00000000, 10000000.00000000, '1,2,5,10,20,50,100', 1, '697d8ac828e8b1769835208.jpg', '2026-01-25 00:22:07', '2026-02-14 15:20:55', 2);
...
INSERT INTO `gateways` (`id`, `form_id`, `code`, `name`, `deposit_number`, `alias`, `image`, `status`, `admin_number`, `receiver_number`, `gateway_parameters`, `supported_currencies`, `crypto`, `extra`, `description`, `created_at`, `updated_at`) VALUES
(1, 0, 101, 'Paypal', NULL, 'Paypal', NULL, 1, NULL, NULL, '{\"paypal_email\":{\"title\":\"PayPal Email\",\"global\":true,\"value\":\"sb-owud61543012@business.example.com\"}}', '{\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CZK\":\"CZK\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"HKD\":\"HKD\",\"HUF\":\"HUF\",\"INR\":\"INR\",\"ILS\":\"ILS\",\"JPY\":\"JPY\",\"MYR\":\"MYR\",\"MXN\":\"MXN\",\"TWD\":\"TWD\",\"NZD\":\"NZD\",\"NOK\":\"NOK\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"GBP\":\"GBP\",\"RUB\":\"RUB\",\"SGD\":\"SGD\",\"SEK\":\"SEK\",\"CHF\":\"CHF\",\"THB\":\"THB\",\"USD\":\"$\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 00:04:38'),
(2, 0, 102, 'Perfect Money', NULL, 'PerfectMoney', NULL, 1, NULL, NULL, '{\"passphrase\":{\"title\":\"ALTERNATE PASSPHRASE\",\"global\":true,\"value\":\"hR26aw02Q1eEeUPSIfuwNypXX\"},\"wallet_id\":{\"title\":\"PM Wallet\",\"global\":false,\"value\":\"\"}}', '{\"USD\":\"$\",\"EUR\":\"\\u20ac\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 01:35:33'),
(3, 0, 103, 'Stripe Hosted', NULL, 'Stripe', NULL, 1, NULL, NULL, '{\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"sk_test_51I6GGiCGv1sRiQlEi5v1or9eR0HVbuzdMd2rW4n3DxC8UKfz66R4X6n4yYkzvI2LeAIuRU9H99ZpY7XCNFC9xMs500vBjZGkKG\"},\"publishable_key\":{\"title\":\"PUBLISHABLE KEY\",\"global\":true,\"value\":\"pk_test_51I6GGiCGv1sRiQlEOisPKrjBqQqqcFsw8mXNaZ2H2baN6R01NulFS7dKFji1NRRxuchoUTEDdB7ujKcyKYSVc0z500eth7otOM\"}}', '{\"USD\":\"USD\",\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"SGD\":\"SGD\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 00:48:36'),
(4, 0, 104, 'Skrill', NULL, 'Skrill', NULL, 1, NULL, NULL, '{\"pay_to_email\":{\"title\":\"Skrill Email\",\"global\":true,\"value\":\"merchant@skrill.com\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"---\"}}', '{\"AED\":\"AED\",\"AUD\":\"AUD\",\"BGN\":\"BGN\",\"BHD\":\"BHD\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CZK\":\"CZK\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"HRK\":\"HRK\",\"HUF\":\"HUF\",\"ILS\":\"ILS\",\"INR\":\"INR\",\"ISK\":\"ISK\",\"JOD\":\"JOD\",\"JPY\":\"JPY\",\"KRW\":\"KRW\",\"KWD\":\"KWD\",\"MAD\":\"MAD\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"OMR\":\"OMR\",\"PLN\":\"PLN\",\"QAR\":\"QAR\",\"RON\":\"RON\",\"RSD\":\"RSD\",\"SAR\":\"SAR\",\"SEK\":\"SEK\",\"SGD\":\"SGD\",\"THB\":\"THB\",\"TND\":\"TND\",\"TRY\":\"TRY\",\"TWD\":\"TWD\",\"USD\":\"USD\",\"ZAR\":\"ZAR\",\"COP\":\"COP\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 01:30:16'),
(5, 0, 105, 'PayTM', NULL, 'Paytm', NULL, 1, NULL, NULL, '{\"MID\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"DIY12386817555501617\"},\"merchant_key\":{\"title\":\"Merchant Key\",\"global\":true,\"value\":\"bKMfNxPPf_QdZppa\"},\"WEBSITE\":{\"title\":\"Paytm Website\",\"global\":true,\"value\":\"DIYtestingweb\"},\"INDUSTRY_TYPE_ID\":{\"title\":\"Industry Type\",\"global\":true,\"value\":\"Retail\"},\"CHANNEL_ID\":{\"title\":\"CHANNEL ID\",\"global\":true,\"value\":\"WEB\"},\"transaction_url\":{\"title\":\"Transaction URL\",\"global\":true,\"value\":\"https:\\/\\/pguat.paytm.com\\/oltp-web\\/processTransaction\"},\"transaction_status_url\":{\"title\":\"Transaction STATUS URL\",\"global\":true,\"value\":\"https:\\/\\/pguat.paytm.com\\/paytmchecksum\\/paytmCallback.jsp\"}}', '{\"AUD\":\"AUD\",\"ARS\":\"ARS\",\"BDT\":\"BDT\",\"BRL\":\"BRL\",\"BGN\":\"BGN\",\"CAD\":\"CAD\",\"CLP\":\"CLP\",\"CNY\":\"CNY\",\"COP\":\"COP\",\"HRK\":\"HRK\",\"CZK\":\"CZK\",\"DKK\":\"DKK\",\"EGP\":\"EGP\",\"EUR\":\"EUR\",\"GEL\":\"GEL\",\"GHS\":\"GHS\",\"HKD\":\"HKD\",\"HUF\":\"HUF\",\"INR\":\"INR\",\"IDR\":\"IDR\",\"ILS\":\"ILS\",\"JPY\":\"JPY\",\"KES\":\"KES\",\"MYR\":\"MYR\",\"MXN\":\"MXN\",\"MAD\":\"MAD\",\"NPR\":\"NPR\",\"NZD\":\"NZD\",\"NGN\":\"NGN\",\"NOK\":\"NOK\",\"PKR\":\"PKR\",\"PEN\":\"PEN\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"RON\":\"RON\",\"RUB\":\"RUB\",\"SGD\":\"SGD\",\"ZAR\":\"ZAR\",\"KRW\":\"KRW\",\"LKR\":\"LKR\",\"SEK\":\"SEK\",\"CHF\":\"CHF\",\"THB\":\"THB\",\"TRY\":\"TRY\",\"UGX\":\"UGX\",\"UAH\":\"UAH\",\"AED\":\"AED\",\"GBP\":\"GBP\",\"USD\":\"USD\",\"VND\":\"VND\",\"XOF\":\"XOF\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 03:00:44'),
(6, 0, 106, 'Payeer', NULL, 'Payeer', NULL, 0, NULL, NULL, '{\"merchant_id\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"866989763\"},\"secret_key\":{\"title\":\"Secret key\",\"global\":true,\"value\":\"7575\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\",\"RUB\":\"RUB\"}', 0, '{\"status\":{\"title\": \"Status URL\",\"value\":\"ipn.Payeer\"}}', NULL, '2019-09-14 13:14:22', '2020-12-28 01:26:58'),
(7, 0, 107, 'PayStack', NULL, 'Paystack', NULL, 1, NULL, NULL, '{\"public_key\":{\"title\":\"Public key\",\"global\":true,\"value\":\"pk_test_cd330608eb47970889bca397ced55c1dd5ad3783\"},\"secret_key\":{\"title\":\"Secret key\",\"global\":true,\"value\":\"sk_test_8a0b1f199362d7acc9c390bff72c4e81f74e2ac3\"}}', '{\"USD\":\"USD\",\"NGN\":\"NGN\"}', 0, '{\"callback\":{\"title\": \"Callback URL\",\"value\":\"ipn.Paystack\"},\"webhook\":{\"title\": \"Webhook URL\",\"value\":\"ipn.Paystack\"}}\r\n', NULL, '2019-09-14 13:14:22', '2021-05-21 01:49:51'),
(9, 0, 109, 'Flutterwave', NULL, 'Flutterwave', NULL, 1, NULL, NULL, '{\"public_key\":{\"title\":\"Public Key\",\"global\":true,\"value\":\"----------------\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"-----------------------\"},\"encryption_key\":{\"title\":\"Encryption Key\",\"global\":true,\"value\":\"------------------\"}}', '{\"BIF\":\"BIF\",\"CAD\":\"CAD\",\"CDF\":\"CDF\",\"CVE\":\"CVE\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"GHS\":\"GHS\",\"GMD\":\"GMD\",\"GNF\":\"GNF\",\"KES\":\"KES\",\"LRD\":\"LRD\",\"MWK\":\"MWK\",\"MZN\":\"MZN\",\"NGN\":\"NGN\",\"RWF\":\"RWF\",\"SLL\":\"SLL\",\"STD\":\"STD\",\"TZS\":\"TZS\",\"UGX\":\"UGX\",\"USD\":\"USD\",\"XAF\":\"XAF\",\"XOF\":\"XOF\",\"ZMK\":\"ZMK\",\"ZMW\":\"ZMW\",\"ZWD\":\"ZWD\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-06-05 11:37:45'),
(10, 0, 110, 'RazorPay', NULL, 'Razorpay', NULL, 1, NULL, NULL, '{\"key_id\":{\"title\":\"Key Id\",\"global\":true,\"value\":\"rzp_test_kiOtejPbRZU90E\"},\"key_secret\":{\"title\":\"Key Secret \",\"global\":true,\"value\":\"osRDebzEqbsE1kbyQJ4y0re7\"}}', '{\"INR\":\"INR\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:51:32'),
(11, 0, 111, 'Stripe Storefront', NULL, 'StripeJs', NULL, 1, NULL, NULL, '{\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"sk_test_51I6GGiCGv1sRiQlEi5v1or9eR0HVbuzdMd2rW4n3DxC8UKfz66R4X6n4yYkzvI2LeAIuRU9H99ZpY7XCNFC9xMs500vBjZGkKG\"},\"publishable_key\":{\"title\":\"PUBLISHABLE KEY\",\"global\":true,\"value\":\"pk_test_51I6GGiCGv1sRiQlEOisPKrjBqQqqcFsw8mXNaZ2H2baN6R01NulFS7dKFji1NRRxuchoUTEDdB7ujKcyKYSVc0z500eth7otOM\"}}', '{\"USD\":\"USD\",\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"SGD\":\"SGD\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 00:53:10'),
(12, 0, 112, 'Instamojo', NULL, 'Instamojo', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API KEY\",\"global\":true,\"value\":\"test_2241633c3bc44a3de84a3b33969\"},\"auth_token\":{\"title\":\"Auth Token\",\"global\":true,\"value\":\"test_279f083f7bebefd35217feef22d\"},\"salt\":{\"title\":\"Salt\",\"global\":true,\"value\":\"19d38908eeff4f58b2ddda2c6d86ca25\"}}', '{\"INR\":\"INR\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:56:20'),
(13, 0, 501, 'Blockchain', NULL, 'Blockchain', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"55529946-05ca-48ff-8710-f279d86b1cc5\"},\"xpub_code\":{\"title\":\"XPUB CODE\",\"global\":true,\"value\":\"xpub6CKQ3xxWyBoFAF83izZCSFUorptEU9AF8TezhtWeMU5oefjX3sFSBw62Lr9iHXPkXmDQJJiHZeTRtD9Vzt8grAYRhvbz4nEvBu3QKELVzFK\"}}', '{\"BTC\":\"BTC\"}', 1, NULL, NULL, '2019-09-14 13:14:22', '2022-03-21 07:41:56'),
(15, 0, 503, 'CoinPayments', NULL, 'Coinpayments', NULL, 1, NULL, NULL, '{\"public_key\":{\"title\":\"Public Key\",\"global\":true,\"value\":\"---------------\"},\"private_key\":{\"title\":\"Private Key\",\"global\":true,\"value\":\"------------\"},\"merchant_id\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"93a1e014c4ad60a7980b4a7239673cb4\"}}', '{\"BTC\":\"Bitcoin\",\"BTC.LN\":\"Bitcoin (Lightning Network)\",\"LTC\":\"Litecoin\",\"CPS\":\"CPS Coin\",\"VLX\":\"Velas\",\"APL\":\"Apollo\",\"AYA\":\"Aryacoin\",\"BAD\":\"Badcoin\",\"BCD\":\"Bitcoin Diamond\",\"BCH\":\"Bitcoin Cash\",\"BCN\":\"Bytecoin\",\"BEAM\":\"BEAM\",\"BITB\":\"Bean Cash\",\"BLK\":\"BlackCoin\",\"BSV\":\"Bitcoin SV\",\"BTAD\":\"Bitcoin Adult\",\"BTG\":\"Bitcoin Gold\",\"BTT\":\"BitTorrent\",\"CLOAK\":\"CloakCoin\",\"CLUB\":\"ClubCoin\",\"CRW\":\"Crown\",\"CRYP\":\"CrypticCoin\",\"CRYT\":\"CryTrExCoin\",\"CURE\":\"CureCoin\",\"DASH\":\"DASH\",\"DCR\":\"Decred\",\"DEV\":\"DeviantCoin\",\"DGB\":\"DigiByte\",\"DOGE\":\"Dogecoin\",\"EBST\":\"eBoost\",\"EOS\":\"EOS\",\"ETC\":\"Ether Classic\",\"ETH\":\"Ethereum\",\"ETN\":\"Electroneum\",\"EUNO\":\"EUNO\",\"EXP\":\"EXP\",\"Expanse\":\"Expanse\",\"FLASH\":\"FLASH\",\"GAME\":\"GameCredits\",\"GLC\":\"Goldcoin\",\"GRS\":\"Groestlcoin\",\"KMD\":\"Komodo\",\"LOKI\":\"LOKI\",\"LSK\":\"LSK\",\"MAID\":\"MaidSafeCoin\",\"MUE\":\"MonetaryUnit\",\"NAV\":\"NAV Coin\",\"NEO\":\"NEO\",\"NMC\":\"Namecoin\",\"NVST\":\"NVO Token\",\"NXT\":\"NXT\",\"OMNI\":\"OMNI\",\"PINK\":\"PinkCoin\",\"PIVX\":\"PIVX\",\"POT\":\"PotCoin\",\"PPC\":\"Peercoin\",\"PROC\":\"ProCurrency\",\"PURA\":\"PURA\",\"QTUM\":\"QTUM\",\"RES\":\"Resistance\",\"RVN\":\"Ravencoin\",\"RVR\":\"RevolutionVR\",\"SBD\":\"Steem Dollars\",\"SMART\":\"SmartCash\",\"SOXAX\":\"SOXAX\",\"STEEM\":\"STEEM\",\"STRAT\":\"STRAT\",\"SYS\":\"Syscoin\",\"TPAY\":\"TokenPay\",\"TRIGGERS\":\"Triggers\",\"TRX\":\" TRON\",\"UBQ\":\"Ubiq\",\"UNIT\":\"UniversalCurrency\",\"USDT\":\"Tether USD (Omni Layer)\",\"USDT.BEP20\":\"Tether USD (BSC Chain)\",\"USDT.ERC20\":\"Tether USD (ERC20)\",\"USDT.TRC20\":\"Tether USD (Tron/TRC20)\",\"VTC\":\"Vertcoin\",\"WAVES\":\"Waves\",\"XCP\":\"Counterparty\",\"XEM\":\"NEM\",\"XMR\":\"Monero\",\"XSN\":\"Stakenet\",\"XSR\":\"SucreCoin\",\"XVG\":\"VERGE\",\"XZC\":\"ZCoin\",\"ZEC\":\"ZCash\",\"ZEN\":\"Horizen\"}', 1, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:07:14'),
(16, 0, 504, 'CoinPayments Fiat', NULL, 'CoinpaymentsFiat', NULL, 1, NULL, NULL, '{\"merchant_id\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"6515561\"}}', '{\"USD\":\"USD\",\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CLP\":\"CLP\",\"CNY\":\"CNY\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"INR\":\"INR\",\"ISK\":\"ISK\",\"JPY\":\"JPY\",\"KRW\":\"KRW\",\"NZD\":\"NZD\",\"PLN\":\"PLN\",\"RUB\":\"RUB\",\"SEK\":\"SEK\",\"SGD\":\"SGD\",\"THB\":\"THB\",\"TWD\":\"TWD\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:07:44'),
(17, 0, 505, 'Coingate', NULL, 'Coingate', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"6354mwVCEw5kHzRJ6thbGo-N\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2022-03-30 09:24:57'),
(18, 0, 506, 'Coinbase Commerce', NULL, 'CoinbaseCommerce', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"c47cd7df-d8e8-424b-a20a\"},\"secret\":{\"title\":\"Webhook Shared Secret\",\"global\":true,\"value\":\"55871878-2c32-4f64-ab66\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\",\"JPY\":\"JPY\",\"GBP\":\"GBP\",\"AUD\":\"AUD\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CNY\":\"CNY\",\"SEK\":\"SEK\",\"NZD\":\"NZD\",\"MXN\":\"MXN\",\"SGD\":\"SGD\",\"HKD\":\"HKD\",\"NOK\":\"NOK\",\"KRW\":\"KRW\",\"TRY\":\"TRY\",\"RUB\":\"RUB\",\"INR\":\"INR\",\"BRL\":\"BRL\",\"ZAR\":\"ZAR\",\"AED\":\"AED\",\"AFN\":\"AFN\",\"ALL\":\"ALL\",\"AMD\":\"AMD\",\"ANG\":\"ANG\",\"AOA\":\"AOA\",\"ARS\":\"ARS\",\"AWG\":\"AWG\",\"AZN\":\"AZN\",\"BAM\":\"BAM\",\"BBD\":\"BBD\",\"BDT\":\"BDT\",\"BGN\":\"BGN\",\"BHD\":\"BHD\",\"BIF\":\"BIF\",\"BMD\":\"BMD\",\"BND\":\"BND\",\"BOB\":\"BOB\",\"BSD\":\"BSD\",\"BTN\":\"BTN\",\"BWP\":\"BWP\",\"BYN\":\"BYN\",\"BZD\":\"BZD\",\"CDF\":\"CDF\",\"CLF\":\"CLF\",\"CLP\":\"CLP\",\"COP\":\"COP\",\"CRC\":\"CRC\",\"CUC\":\"CUC\",\"CUP\":\"CUP\",\"CVE\":\"CVE\",\"CZK\":\"CZK\",\"DJF\":\"DJF\",\"DKK\":\"DKK\",\"DOP\":\"DOP\",\"DZD\":\"DZD\",\"EGP\":\"EGP\",\"ERN\":\"ERN\",\"ETB\":\"ETB\",\"FJD\":\"FJD\",\"FKP\":\"FKP\",\"GEL\":\"GEL\",\"GGP\":\"GGP\",\"GHS\":\"GHS\",\"GIP\":\"GIP\",\"GMD\":\"GMD\",\"GNF\":\"GNF\",\"GTQ\":\"GTQ\",\"GYD\":\"GYD\",\"HNL\":\"HNL\",\"HRK\":\"HRK\",\"HTG\":\"HTG\",\"HUF\":\"HUF\",\"IDR\":\"IDR\",\"ILS\":\"ILS\",\"IMP\":\"IMP\",\"IQD\":\"IQD\",\"IRR\":\"IRR\",\"ISK\":\"ISK\",\"JEP\":\"JEP\",\"JMD\":\"JMD\",\"JOD\":\"JOD\",\"KES\":\"KES\",\"KGS\":\"KGS\",\"KHR\":\"KHR\",\"KMF\":\"KMF\",\"KPW\":\"KPW\",\"KWD\":\"KWD\",\"KYD\":\"KYD\",\"KZT\":\"KZT\",\"LAK\":\"LAK\",\"LBP\":\"LBP\",\"LKR\":\"LKR\",\"LRD\":\"LRD\",\"LSL\":\"LSL\",\"LYD\":\"LYD\",\"MAD\":\"MAD\",\"MDL\":\"MDL\",\"MGA\":\"MGA\",\"MKD\":\"MKD\",\"MMK\":\"MMK\",\"MNT\":\"MNT\",\"MOP\":\"MOP\",\"MRO\":\"MRO\",\"MUR\":\"MUR\",\"MVR\":\"MVR\",\"MWK\":\"MWK\",\"MYR\":\"MYR\",\"MZN\":\"MZN\",\"NAD\":\"NAD\",\"NGN\":\"NGN\",\"NIO\":\"NIO\",\"NPR\":\"NPR\",\"OMR\":\"OMR\",\"PAB\":\"PAB\",\"PEN\":\"PEN\",\"PGK\":\"PGK\",\"PHP\":\"PHP\",\"PKR\":\"PKR\",\"PLN\":\"PLN\",\"PYG\":\"PYG\",\"QAR\":\"QAR\",\"RON\":\"RON\",\"RSD\":\"RSD\",\"RWF\":\"RWF\",\"SAR\":\"SAR\",\"SBD\":\"SBD\",\"SCR\":\"SCR\",\"SDG\":\"SDG\",\"SHP\":\"SHP\",\"SLL\":\"SLL\",\"SOS\":\"SOS\",\"SRD\":\"SRD\",\"SSP\":\"SSP\",\"STD\":\"STD\",\"SVC\":\"SVC\",\"SYP\":\"SYP\",\"SZL\":\"SZL\",\"THB\":\"THB\",\"TJS\":\"TJS\",\"TMT\":\"TMT\",\"TND\":\"TND\",\"TOP\":\"TOP\",\"TTD\":\"TTD\",\"TWD\":\"TWD\",\"TZS\":\"TZS\",\"UAH\":\"UAH\",\"UGX\":\"UGX\",\"UYU\":\"UYU\",\"UZS\":\"UZS\",\"VEF\":\"VEF\",\"VND\":\"VND\",\"VUV\":\"VUV\",\"WST\":\"WST\",\"XAF\":\"XAF\",\"XAG\":\"XAG\",\"XAU\":\"XAU\",\"XCD\":\"XCD\",\"XDR\":\"XDR\",\"XOF\":\"XOF\",\"XPD\":\"XPD\",\"XPF\":\"XPF\",\"XPT\":\"XPT\",\"YER\":\"YER\",\"ZMW\":\"ZMW\",\"ZWL\":\"ZWL\"}\r\n\r\n', 0, '{\"endpoint\":{\"title\": \"Webhook Endpoint\",\"value\":\"ipn.CoinbaseCommerce\"}}', NULL, '2019-09-14 13:14:22', '2021-05-21 02:02:47'),
(24, 0, 113, 'Paypal Express', NULL, 'PaypalSdk', NULL, 1, NULL, NULL, '{\"clientId\":{\"title\":\"Paypal Client ID\",\"global\":true,\"value\":\"Ae0-tixtSV7DvLwIh3Bmu7JvHrjh5EfGdXr_cEklKAVjjezRZ747BxKILiBdzlKKyp-W8W_T7CKH1Ken\"},\"clientSecret\":{\"title\":\"Client Secret\",\"global\":true,\"value\":\"EOhbvHZgFNO21soQJT1L9Q00M3rK6PIEsdiTgXRBt2gtGtxwRer5JvKnVUGNU5oE63fFnjnYY7hq3HBA\"}}', '{\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CZK\":\"CZK\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"HKD\":\"HKD\",\"HUF\":\"HUF\",\"INR\":\"INR\",\"ILS\":\"ILS\",\"JPY\":\"JPY\",\"MYR\":\"MYR\",\"MXN\":\"MXN\",\"TWD\":\"TWD\",\"NZD\":\"NZD\",\"NOK\":\"NOK\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"GBP\":\"GBP\",\"RUB\":\"RUB\",\"SGD\":\"SGD\",\"SEK\":\"SEK\",\"CHF\":\"CHF\",\"THB\":\"THB\",\"USD\":\"$\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-20 23:01:08'),
(25, 0, 114, 'Stripe Checkout', NULL, 'StripeV3', NULL, 1, NULL, NULL, '{\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"sk_test_51I6GGiCGv1sRiQlEi5v1or9eR0HVbuzdMd2rW4n3DxC8UKfz66R4X6n4yYkzvI2LeAIuRU9H99ZpY7XCNFC9xMs500vBjZGkKG\"},\"publishable_key\":{\"title\":\"PUBLISHABLE KEY\",\"global\":true,\"value\":\"pk_test_51I6GGiCGv1sRiQlEOisPKrjBqQqqcFsw8mXNaZ2H2baN6R01NulFS7dKFji1NRRxuchoUTEDdB7ujKcyKYSVc0z500eth7otOM\"},\"end_point\":{\"title\":\"End Point Secret\",\"global\":true,\"value\":\"whsec_lUmit1gtxwKTveLnSe88xCSDdnPOt8g5\"}}', '{\"USD\":\"USD\",\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"SGD\":\"SGD\"}', 0, '{\"webhook\":{\"title\": \"Webhook Endpoint\",\"value\":\"ipn.StripeV3\"}}', NULL, '2019-09-14 13:14:22', '2021-05-21 00:58:38'),
(27, 0, 115, 'Mollie', NULL, 'Mollie', NULL, 1, NULL, NULL, '{\"mollie_email\":{\"title\":\"Mollie Email \",\"global\":true,\"value\":\"vi@gmail.com\"},\"api_key\":{\"title\":\"API KEY\",\"global\":true,\"value\":\"test_cucfwKTWfft9s337qsVfn5CC4vNkrn\"}}', '{\"AED\":\"AED\",\"AUD\":\"AUD\",\"BGN\":\"BGN\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CZK\":\"CZK\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"HRK\":\"HRK\",\"HUF\":\"HUF\",\"ILS\":\"ILS\",\"ISK\":\"ISK\",\"JPY\":\"JPY\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"RON\":\"RON\",\"RUB\":\"RUB\",\"SEK\":\"SEK\",\"SGD\":\"SGD\",\"THB\":\"THB\",\"TWD\":\"TWD\",\"USD\":\"USD\",\"ZAR\":\"ZAR\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:44:45'),
(30, 0, 116, 'Cashmaal', NULL, 'Cashmaal', NULL, 1, NULL, NULL, '{\"web_id\":{\"title\":\"Web Id\",\"global\":true,\"value\":\"3748\"},\"ipn_key\":{\"title\":\"IPN Key\",\"global\":true,\"value\":\"546254628759524554647987\"}}', '{\"PKR\":\"PKR\",\"USD\":\"USD\"}', 0, '{\"webhook\":{\"title\": \"IPN URL\",\"value\":\"ipn.Cashmaal\"}}', NULL, NULL, '2021-06-22 08:05:04'),
(36, 0, 119, 'Mercado Pago', NULL, 'MercadoPago', NULL, 1, NULL, NULL, '{\"access_token\":{\"title\":\"Access Token\",\"global\":true,\"value\":\"3Vee5S2F\"}}', '{\"USD\":\"USD\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"NOK\":\"NOK\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"AUD\":\"AUD\",\"NZD\":\"NZD\"}', 0, NULL, NULL, NULL, '2021-07-17 09:44:29'),
(44, 0, 120, 'Authorize.net', NULL, 'Authorize', NULL, 1, NULL, NULL, '{\"login_id\":{\"title\":\"Login ID\",\"global\":true,\"value\":\"3Vee5S2F\"},\"transaction_key\":{\"title\":\"Transaction Key\",\"global\":true,\"value\":\"3Vee5S2F\"}}', '{\"USD\":\"USD\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"NOK\":\"NOK\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"AUD\":\"AUD\",\"NZD\":\"NZD\"}', 0, NULL, NULL, NULL, '2022-09-15 09:27:31'),
(46, 0, 121, 'NMI', NULL, 'NMI', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"2F822Rw39fx762MaV7Yy86jXGTC7sCDy\"}}', '{\"AED\":\"AED\",\"ARS\":\"ARS\",\"AUD\":\"AUD\",\"BOB\":\"BOB\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CLP\":\"CLP\",\"CNY\":\"CNY\",\"COP\":\"COP\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"IDR\":\"IDR\",\"ILS\":\"ILS\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"KRW\":\"KRW\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PEN\":\"PEN\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"PYG\":\"PYG\",\"RUB\":\"RUB\",\"SEC\":\"SEC\",\"SGD\":\"SGD\",\"THB\":\"THB\",\"TRY\":\"TRY\",\"TWD\":\"TWD\",\"USD\":\"USD\",\"ZAR\":\"ZAR\"}', 0, NULL, NULL, NULL, '2022-09-10 05:30:15'),
(49, 0, 122, 'BTCPay', NULL, 'BTCPay', NULL, 1, NULL, NULL, '{\"store_id\":{\"title\":\"Store Id\",\"global\":true,\"value\":\"-------\"},\"api_key\":{\"title\":\"Api Key\",\"global\":true,\"value\":\"------\"},\"server_name\":{\"title\":\"Server Name\",\"global\":true,\"value\":\"https:\\/\\/yourbtcpaserver.lndyn.com\"},\"secret_code\":{\"title\":\"Secret Code\",\"global\":true,\"value\":\"----------\"}}', '{\"BTC\":\"Bitcoin\",\"LTC\":\"Litecoin\"}', 1, '{\"webhook\":{\"title\": \"IPN URL\",\"value\":\"ipn.BTCPay\"}}', NULL, NULL, NULL),
(50, 0, 123, 'Now payments hosted', NULL, 'NowPaymentsHosted', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"-------------------\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"--------------\"}}', '{\"BTG\":\"BTG\",\"ETH\":\"ETH\",\"XMR\":\"XMR\",\"ZEC\":\"ZEC\",\"XVG\":\"XVG\",\"ADA\":\"ADA\",\"LTC\":\"LTC\",\"BCH\":\"BCH\",\"QTUM\":\"QTUM\",\"DASH\":\"DASH\",\"XLM\":\"XLM\",\"XRP\":\"XRP\",\"XEM\":\"XEM\",\"DGB\":\"DGB\",\"LSK\":\"LSK\",\"DOGE\":\"DOGE\",\"TRX\":\"TRX\",\"KMD\":\"KMD\",\"REP\":\"REP\",\"BAT\":\"BAT\",\"ARK\":\"ARK\",\"WAVES\":\"WAVES\",\"BNB\":\"BNB\",\"XZC\":\"XZC\",\"NANO\":\"NANO\",\"TUSD\":\"TUSD\",\"VET\":\"VET\",\"ZEN\":\"ZEN\",\"GRS\":\"GRS\",\"FUN\":\"FUN\",\"NEO\":\"NEO\",\"GAS\":\"GAS\",\"PAX\":\"PAX\",\"USDC\":\"USDC\",\"ONT\":\"ONT\",\"XTZ\":\"XTZ\",\"LINK\":\"LINK\",\"RVN\":\"RVN\",\"BNBMAINNET\":\"BNBMAINNET\",\"ZIL\":\"ZIL\",\"BCD\":\"BCD\",\"USDT\":\"USDT\",\"USDTERC20\":\"USDTERC20\",\"CRO\":\"CRO\",\"DAI\":\"DAI\",\"HT\":\"HT\",\"WABI\":\"WABI\",\"BUSD\":\"BUSD\",\"ALGO\":\"ALGO\",\"USDTTRC20\":\"USDTTRC20\",\"GT\":\"GT\",\"STPT\":\"STPT\",\"AVA\":\"AVA\",\"SXP\":\"SXP\",\"UNI\":\"UNI\",\"OKB\":\"OKB\",\"BTC\":\"BTC\"}', 1, '', NULL, NULL, '2023-02-14 10:42:09'),
(51, 0, 509, 'Now payments checkout', NULL, 'NowPaymentsCheckout', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"-------------------\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"--------------\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\"}', 1, '', NULL, NULL, '2023-02-14 10:42:09'),
(56, 0, 124, '2Checkout', NULL, 'TwoCheckout', NULL, 1, NULL, NULL, '{\"merchant_code\":{\"title\":\"Merchant Code\",\"global\":true,\"value\":\"253248016872\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"eQM)ID@&vG84u!O*g[p+\"}}', '{\"AFN\": \"AFN\",\"ALL\": \"ALL\",\"DZD\": \"DZD\",\"ARS\": \"ARS\",\"AUD\": \"AUD\",\"AZN\": \"AZN\",\"BSD\": \"BSD\",\"BDT\": \"BDT\",\"BBD\": \"BBD\",\"BZD\": \"BZD\",\"BMD\": \"BMD\",\"BOB\": \"BOB\",\"BWP\": \"BWP\",\"BRL\": \"BRL\",\"GBP\": \"GBP\",\"BND\": \"BND\",\"BGN\": \"BGN\",\"CAD\": \"CAD\",\"CLP\": \"CLP\",\"CNY\": \"CNY\",\"COP\": \"COP\",\"CRC\": \"CRC\",\"HRK\": \"HRK\",\"CZK\": \"CZK\",\"DKK\": \"DKK\",\"DOP\": \"DOP\",\"XCD\": \"XCD\",\"EGP\": \"EGP\",\"EUR\": \"EUR\",\"FJD\": \"FJD\",\"GTQ\": \"GTQ\",\"HKD\": \"HKD\",\"HNL\": \"HNL\",\"HUF\": \"HUF\",\"INR\": \"INR\",\"IDR\": \"IDR\",\"ILS\": \"ILS\",\"JMD\": \"JMD\",\"JPY\": \"JPY\",\"KZT\": \"KZT\",\"KES\": \"KES\",\"LAK\": \"LAK\",\"MMK\": \"MMK\",\"LBP\": \"LBP\",\"LRD\": \"LRD\",\"MOP\": \"MOP\",\"MYR\": \"MYR\",\"MVR\": \"MVR\",\"MRO\": \"MRO\",\"MUR\": \"MUR\",\"MXN\": \"MXN\",\"MAD\": \"MAD\",\"NPR\": \"NPR\",\"TWD\": \"TWD\",\"NZD\": \"NZD\",\"NIO\": \"NIO\",\"NOK\": \"NOK\",\"PKR\": \"PKR\",\"PGK\": \"PGK\",\"PEN\": \"PEN\",\"PHP\": \"PHP\",\"PLN\": \"PLN\",\"QAR\": \"QAR\",\"RON\": \"RON\",\"RUB\": \"RUB\",\"WST\": \"WST\",\"SAR\": \"SAR\",\"SCR\": \"SCR\",\"SGD\": \"SGD\",\"SBD\": \"SBD\",\"ZAR\": \"ZAR\",\"KRW\": \"KRW\",\"LKR\": \"LKR\",\"SEK\": \"SEK\",\"CHF\": \"CHF\",\"SYP\": \"SYP\",\"THB\": \"THB\",\"TOP\": \"TOP\",\"TTD\": \"TTD\",\"TRY\": \"TRY\",\"UAH\": \"UAH\",\"AED\": \"AED\",\"USD\": \"USD\",\"VUV\": \"VUV\",\"VND\": \"VND\",\"XOF\": \"XOF\",\"YER\": \"YER\"}', 0, '{\"approved_url\":{\"title\": \"Approved URL\",\"value\":\"ipn.TwoCheckout\"}}', NULL, NULL, '2023-04-29 03:21:58'),
(57, 0, 125, 'Checkout', NULL, 'Checkout', NULL, 1, NULL, NULL, '{\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"------\"},\"public_key\":{\"title\":\"PUBLIC KEY\",\"global\":true,\"value\":\"------\"},\"processing_channel_id\":{\"title\":\"PROCESSING CHANNEL\",\"global\":true,\"value\":\"------\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"AUD\":\"AUD\",\"CAN\":\"CAN\",\"CHF\":\"CHF\",\"SGD\":\"SGD\",\"JPY\":\"JPY\",\"NZD\":\"NZD\"}', 0, NULL, NULL, NULL, '2023-05-06 01:43:01'),
(59, 0, 510, 'Binance', NULL, 'Binance', NULL, 1, NULL, NULL, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"tsu3tjiq0oqfbtmlbevoeraxhfbp3brejnm9txhjxcp4to29ujvakvfl1ibsn3ja\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"jzngq4t04ltw8d4iqpi7admfl8tvnpehxnmi34id1zvfaenbwwvsvw7llw3zdko8\"},\"merchant_id\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"231129033\"}}', '{\"BTC\":\"Bitcoin\",\"USD\":\"USD\",\"BNB\":\"BNB\"}', 1, '{\"cron\":{\"title\": \"Cron Job URL\",\"value\":\"ipn.Binance\"}}', NULL, NULL, '2023-02-14 05:08:04'),
(60, 0, 126, 'SslCommerz', NULL, 'SslCommerz', NULL, 1, NULL, NULL, '{\"store_id\": {\"title\": \"Store ID\",\"global\": true,\"value\": \"---------\"},\"store_password\": {\"title\": \"Store Password\",\"global\": true,\"value\": \"----------\"}}', '{\"BDT\":\"BDT\",\"USD\":\"USD\",\"EUR\":\"EUR\",\"SGD\":\"SGD\",\"INR\":\"INR\",\"MYR\":\"MYR\"}', 0, NULL, NULL, NULL, '2023-05-06 07:43:01'),
(61, 0, 127, 'Aamarpay', NULL, 'Aamarpay', NULL, 1, NULL, NULL, '{\"store_id\": {\"title\": \"Store ID\",\"global\": true,\"value\": \"---------\"},\"signature_key\": {\"title\": \"Signature Key\",\"global\": true,\"value\": \"----------\"}}', '{\"BDT\":\"BDT\"}', 0, NULL, NULL, NULL, '2023-05-06 07:43:01');
...
CREATE TABLE `general_settings` (
  ...
  `referral_parameter` varchar(255) DEFAULT NULL,
  ...
  `broadcast_messages` text DEFAULT NULL,
  `withdraw_off_days` text DEFAULT NULL,
  `trading_setting` text DEFAULT NULL,
  `stock_setting` text DEFAULT NULL,
  `forex_setting` text DEFAULT NULL,
  `games_module` tinyint(1) NOT NULL DEFAULT 1,
  `trading_module` tinyint(1) NOT NULL DEFAULT 1,
  `ai_bot_module` tinyint(1) NOT NULL DEFAULT 1,
  `mining_module` tinyint(1) NOT NULL DEFAULT 1,
  `staking_module` tinyint(1) NOT NULL DEFAULT 1,
  `investment_module` tinyint(1) NOT NULL DEFAULT 1,
  `binary_module` tinyint(1) DEFAULT 0,
  `forex_module` tinyint(4) DEFAULT 1,
  `ptc_module` tinyint(4) DEFAULT 1,
  `stock_module` tinyint(4) NOT NULL DEFAULT 1,
  `license_active` tinyint(1) NOT NULL DEFAULT 0,
  `verified_domain` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, '2025_12_24_194034_fix_general_settings_table_columns', 2),
(5, '2025_12_25_050148_add_withdraw_off_days_to_general_settings_table', 2),
(6, '2025_12_27_073728_add_secondary_password_to_admins_table', 2),
(7, '2025_12_27_074922_add_deposit_number_to_gateways_table', 2),
(8, '2025_12_27_123000_add_secondary_password_to_admins_table', 2),
(9, '2025_12_27_125000_ensure_secondary_auth_columns', 2),
(10, '2025_12_27_133700_create_admin_logins_table', 2),
(11, '2025_12_27_133701_create_admin_ip_bans_table', 2),
(12, '2025_12_27_140600_add_fingerprint_to_admin_logins_table', 2),
(13, '2026_01_04_112907_add_dial_code_to_users_table', 1),
(14, '2000_01_01_000000_import_legacy_database', 1),
(15, '2025_12_24_194034_fix_general_settings_table_columns', 1),
(16, '2025_12_25_050148_add_withdraw_off_days_to_general_settings_table', 1),
(17, '2025_12_27_073728_add_secondary_password_to_admins_table', 1),
(18, '2025_12_27_074922_add_deposit_number_to_gateways_table', 1),
(19, '2026_01_18_170000_create_user_salaries_table', 3),
(20, '2026_01_18_183231_create_promocodes_table', 4),
(21, '2026_01_18_184946_create_daily_rewards_table', 5),
(22, '2026_01_19_005500_add_description_to_daily_reward_logs_table', 6),
(23, '2026_01_19_005900_create_ai_bots_table', 7),
(24, '2026_01_19_162125_create_mining_plans_table', 8),
(25, '2026_01_19_162132_create_user_minings_table', 8),
(26, '2026_01_19_173416_create_game_settings_table', 9),
(27, '2026_01_20_130736_insert_aviator_game', 10),
(28, '2026_01_20_160000_create_aviator_rounds_table', 11),
(29, '2026_01_20_160100_create_aviator_bets_table', 11),
(30, '2026_01_21_152231_delete_aviator_game_setting', 12),
(31, '2026_01_21_152919_delete_plinko_game_setting', 13),
(32, '2026_01_24_072001_add_trading_setting_to_general_settings_table', 14),
(33, '2026_01_24_073046_create_trades_table', 15),
(34, '2026_01_24_073522_add_crypto_currency_to_trades_table', 16),
(35, '2026_01_24_183706_add_max_invest_to_ai_bots_table', 17),
(36, '2026_01_24_190932_add_daily_trade_limit_to_ai_bots_table', 18),
(37, '2026_01_24_192106_create_crash_games_table', 19),
(38, '2026_01_24_205937_create_aviator_upcoming_results_table', 20),
(39, '2026_01_25_014707_add_image_to_plans_table', 21),
(40, '2026_01_25_031658_add_earning_modules_to_general_settings', 22),
(41, '2026_01_28_075946_create_app_play_store_settings_table', 23),
(42, '2026_01_29_183429_create_stocks_table', 24),
(43, '2026_01_29_183818_add_stock_trading_module', 25),
(44, '2026_01_29_190842_create_forex_pairs_table', 26),
(45, '2026_01_29_193415_add_category_settings_to_general_settings', 27),
(46, '2026_01_29_195728_add_stock_module_to_general_settings', 28),
(47, '2026_01_29_023624_create_page_visits_table', 29),
(48, '2026_01_28_000000_add_is_read_to_support_messages_table', 30),
(49, '2026_01_31_222916_add_receiver_number_to_gateways_table', 31),
(50, '2026_02_05_000000_remove_head_tail_game', 32),
(51, '2026_02_08_060049_add_duration_to_mining_plans_and_bots', 32),
(52, '2026_02_08_060503_add_duration_and_dates_to_user_minings', 32),
(53, '2026_02_08_061735_add_duration_to_user_ai_bots', 32),
(54, '2026_02_08_100000_add_time_settings_to_mining_and_bots', 32),
(55, '2026_02_08_102500_update_mining_tables', 32);
...
CREATE TABLE `mining_plans` (
  ...
  `min_return` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `time_setting_id` bigint(20) UNSIGNED DEFAULT NULL,
  `duration` int(11) NOT NULL DEFAULT 1,
  `return_type` varchar(255) NOT NULL DEFAULT 'percentage',
...
CREATE TABLE `promocodes` (
  ...
  `amount` decimal(28,8) NOT NULL,
  `wallet_type` varchar(255) NOT NULL DEFAULT 'interest_wallet',
...
--
-- Table structure for table `promocode_logs`
--

CREATE TABLE `promocode_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `ptc_ads` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) DEFAULT NULL,
  `ad_type` tinyint(4) DEFAULT 1,
  `url` varchar(255) DEFAULT NULL,
  `image` varchar(255) DEFAULT NULL,
  `duration` int(11) DEFAULT 0,
  `amount` decimal(28,8) DEFAULT 0.00000000,
  `max_show` int(11) DEFAULT 0,
...
--
-- Dumping data for table `ptc_ads`
--

INSERT INTO `ptc_ads` (`id`, `title`, `ad_type`, `url`, `image`, `duration`, `amount`, `max_show`, `showed`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Ads', 2, 'https://www.youtube.com/embed/cHnPNVrRaaU', NULL, 5, 5.00000000, 1000, 5, 1, '2026-01-28 23:09:50', '2026-02-15 04:30:12');

-- --------------------------------------------------------

--
-- Table structure for table `ptc_ad_logs`
--

CREATE TABLE `ptc_ad_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
...
(4, 'invest_commission', 1, 10.00, 1, '2026-02-14 13:23:03', '2026-02-14 13:23:03'),
(5, 'invest_commission', 2, 2.00, 1, '2026-02-14 13:23:03', '2026-02-14 13:23:03'),
(6, 'invest_commission', 3, 1.00, 1, '2026-02-14 13:23:03', '2026-02-14 13:23:03');
...
(1, 'Admin', '[\"admin.users.*\",\"admin.setting.*\"]', 1, '2026-02-13 16:57:44', '2026-02-15 04:43:53');
...
INSERT INTO `stocks` (`id`, `name`, `symbol`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Apple Inc.', 'AAPL', NULL, 1, '2026-01-29 23:50:28', '2026-01-29 23:50:28'),
(2, 'Tesla Inc.', 'TSLA', NULL, 1, '2026-01-29 23:50:28', '2026-01-29 23:50:28'),
(3, 'Amazon.com Inc.', 'AMZN', NULL, 1, '2026-01-29 23:50:29', '2026-01-29 23:50:29'),
(4, 'NVIDIA Corp.', 'NVDA', NULL, 1, '2026-01-29 23:50:30', '2026-01-29 23:50:30');
...
(1, 'Day', '24', 1, '2026-01-05 13:57:07', '2026-01-05 13:57:07'),
(2, 'Hour', '1', 1, '2026-02-14 15:07:03', '2026-02-14 15:07:08');
...
CREATE TABLE `trades` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `category` varchar(255) NOT NULL DEFAULT 'Options',
  `stock_id` bigint(20) UNSIGNED DEFAULT NULL,
  `crypto_currency` varchar(255) NOT NULL DEFAULT 'BTCUSDT',
  `amount` decimal(28,8) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `withdrawal_limit` decimal(28,8) DEFAULT 0.00000000,
  `required_referrals` int(11) DEFAULT 0,
  `password` varchar(255) NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deposit_access` tinyint(1) NOT NULL DEFAULT 0,
  `withdraw_access` tinyint(1) NOT NULL DEFAULT 0,
  `referral_required` tinyint(1) NOT NULL DEFAULT 0,
  `ban_new_accounts` tinyint(1) NOT NULL DEFAULT 0,
  `ip_address` varchar(45) DEFAULT NULL,
  `vip_id` bigint(20) UNSIGNED DEFAULT 0,
...
--
-- Table structure for table `user_ai_bots`
--

CREATE TABLE `user_ai_bots` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `ai_bot_id` int(10) UNSIGNED NOT NULL,
  `invest_amount` decimal(28,8) NOT NULL,
  `profit_earned` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `start_at` datetime NOT NULL,
  `end_at` datetime NOT NULL,
  `last_profit_at` datetime DEFAULT NULL,
  `next_profit_at` timestamp NULL DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `duration` int(11) DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `user_minings` (
  ...
  `mining_plan_id` int(11) NOT NULL DEFAULT 0,
  `amount` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `duration` int(11) DEFAULT NULL,
  `start_at` datetime NOT NULL,
  `end_at` datetime NOT NULL,
  `next_profit_at` datetime DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
...
CREATE TABLE `user_salaries` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `min_turnover` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `max_turnover` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `amount` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `user_salary_logs`
--

CREATE TABLE `user_salary_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `user_salary_id` int(10) UNSIGNED NOT NULL,
  `amount` decimal(28,8) NOT NULL DEFAULT 0.00000000,
...
CREATE TABLE `vip_plans` (
  ...
  `daily_ad_limit` int(11) DEFAULT 0,
...
--
-- Indexes for table `admin_ip_bans`
--
ALTER TABLE `admin_ip_bans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `admin_ip_bans_ip_unique` (`ip`);
...
--
-- Indexes for table `ai_bots`
--
ALTER TABLE `ai_bots`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `app_play_store_settings`
--
ALTER TABLE `app_play_store_settings`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `aviator_bets`
  ADD PRIMARY KEY (`id`),
  ADD KEY `aviator_bets_user_id_index` (`user_id`),
  ADD KEY `aviator_bets_aviator_round_id_index` (`aviator_round_id`),
  ADD KEY `aviator_bets_status_index` (`status`);

--
-- Indexes for table `aviator_rounds`
--
ALTER TABLE `aviator_rounds`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `aviator_rounds_round_number_unique` (`round_number`),
  ADD KEY `aviator_rounds_status_index` (`status`),
  ADD KEY `aviator_rounds_round_number_index` (`round_number`);

--
-- Indexes for table `aviator_upcoming_results`
--
ALTER TABLE `aviator_upcoming_results`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `crash_games`
--
ALTER TABLE `crash_games`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `daily_reward_logs`
--
ALTER TABLE `daily_reward_logs`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `page_visits`
  ADD PRIMARY KEY (`id`),
  ADD KEY `page_visits_created_at_url_index` (`created_at`,`url`),
  ADD KEY `page_visits_ip_address_index` (`ip_address`);
...
--
-- Indexes for table `promocode_logs`
--
ALTER TABLE `promocode_logs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ptc_ad_logs`
--
ALTER TABLE `ptc_ad_logs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_ai_bots`
--
ALTER TABLE `user_ai_bots`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_salary_logs`
--
ALTER TABLE `user_salary_logs`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admin_ip_bans`
--
ALTER TABLE `admin_ip_bans`
...
--
-- AUTO_INCREMENT for table `ai_bots`
--
ALTER TABLE `ai_bots`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `app_play_store_settings`
--
ALTER TABLE `app_play_store_settings`
...
--
-- AUTO_INCREMENT for table `aviator_rounds`
--
ALTER TABLE `aviator_rounds`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `aviator_upcoming_results`
--
ALTER TABLE `aviator_upcoming_results`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `crash_games`
--
ALTER TABLE `crash_games`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `daily_reward_logs`
--
ALTER TABLE `daily_reward_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `forex_pairs`
--
ALTER TABLE `forex_pairs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `promocode_logs`
--
ALTER TABLE `promocode_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ptc_ad_logs`
--
ALTER TABLE `ptc_ad_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `user_ai_bots`
--
ALTER TABLE `user_ai_bots`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `user_salary_logs`
--
ALTER TABLE `user_salary_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `aviator_bets`
--
ALTER TABLE `aviator_bets`
  ADD CONSTRAINT `aviator_bets_aviator_round_id_foreign` FOREIGN KEY (`aviator_round_id`) REFERENCES `aviator_rounds` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `aviator_bets_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
