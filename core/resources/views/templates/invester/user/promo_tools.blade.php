                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="referral-form mt-20 ">
                            ...
                            @php
                                $referralParam = gs('referral_parameter') ?? 'reference';
                                $string = '<a href="'.route('home').'?'.$referralParam.'='.base64_encode(auth()->user()->username).'" target="_blank"> <img src="'.getImage(fileManager()->promotions()->path.  '/'. @$banner->banner) .'" alt="image"/></a>';
                            @endphp
